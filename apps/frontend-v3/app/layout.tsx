...
export const metadata: Metadata = {
  title: 'Cryzar - DeFi Liquidity Pools',
  description: `Explore DeFi liquidity pools and swap tokens. The ultimate platform for custom liquidity solutions. Cryzar v1 perfectly balances
