...
import { StakeListSearch } from './StakeListSearch'
import { getProjectConfig } from '@repo/lib/config/getProjectConfig'
import { PROTOCOL_VERSION_TABS } from './useStakeListQueryState'
...
export function StakeListFilters() {
